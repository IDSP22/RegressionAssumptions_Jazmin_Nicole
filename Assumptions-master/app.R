  ...
  dashboardPage(
    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        menuItem("Data analysis", tabName = "datexplore", icon = icon("dashboard")), ##Add tab for data exploration. Maybe change icon later // We want to add in this part what would have happened if we had evaluated the data. 
    ...
    dashboardBody(
      tabItems(
        ...
        tabItem(
          ...
          useShinyalert(),
          h2("Data analysis"),
          p("How data would have looked before running the model."
          ),
          plotOutput(
            outputId = "boxplot",
            width = "100%",
